...
from core.refinamentos_ocr.imagem import refinar_imagem_para_ocr
from core.refinamentos_ocr.planta_implantacao import analisar_implantacao
from core.refinamentos_ocr.carimbo import analisar_carimbo
...
async def inferir_imagem(file: UploadFile = File(...)):
    try:
        ...
        largura_maxima = 4000  # ajuste conforme necessário
        altura_maxima = 4000   # ajuste conforme necessário
        ...
        for box in resultados[0].boxes:
            ...
            if classe == "implantacao":
                analises_semanticas["implantacao_analise"] = analisar_implantacao(linhas)

            if classe == "carimbo":
                analises_semanticas["carimbo_analise"] = analisar_carimbo(linhas)

        with open(os.path.join(pasta_resultado, "resultado_ocr.json"), "w", encoding="utf-8") as f:
            json.dump({
